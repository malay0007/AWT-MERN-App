        ...
        {!loading && scores.map((s, i) => (
          <div key={s._id} style={{
            ...
            <div style={{ textAlign: 'right' }}>
              <div style={{ fontFamily: 'var(--font-head)', fontSize: '20px', fontWeight: 800, color: 'var(--purple)' }}>{s.score}%</div>
              <div style={{ fontSize: '11px', color: 'var(--muted)' }}>{s.correct}/{s.total} correct</div>
            </div>
          </div>
        ))}
      </div>
